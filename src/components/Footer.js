            ...
            <div className='col-4'>
              ...
              <div>
                <address className='text-white fs-6'>
                  Hno: 069 Near Anta Showroom, <br /> Saraswatinagar, kapan <br />
                  PinCode: 446600
                </address>
                <a href='tel:+977 9746899082' className='mt-3 d-block mb-1 text-white'>
                  +977 9746899082
                </a>
                <a href='mail:stha.swagat11@gmail.com' className='mt-2 d-block mb-0 text-white'>
                  stha.swagat11@gmail.com
                </a>
          ...
          <div className='row'>
            <div className='col-12'>
              <p className='text-center mb-0 text-white'>
                &copy; {new Date().getFullYear()}; Powered by Developer|Swagat Shrestha
              </p>
            </div>
          </div>
        </div>
